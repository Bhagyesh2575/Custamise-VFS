...
void man(char *name)
{
    ...
    {
        printf("Description : Used into write regular file\n");
        printf("Usage : write file name\nAAfter this enter the data that we want write\n");
    }
    ...
    {
        printf("Description : Used to display information of file\n");
        printf("Usage : stat File_Discripter\n");
    }
    ...
    {
        printf("Deciption : Used to open existio file\n");
        printf("Usage : open File_name mode\n");
    }
    else if(strcmp(name,"close") == 0)
    {
        printf("Description : Used to close opend file\n");
        printf("Usage : close_File name\n");
    }
    else if(strcmp(name,"closeall") == 0)
    {
        printf("Decription : Used to close all opened files\n");
    ...
    {
        printf("Decription : Used to delete opened files\n");
...
void DisplayHelp()
{
    ...
    printf("write : To erites contends into file\n");
    printf("exit : To terminate file system\n");
    printf("stat : To Display information of file using name\n");
    printf("fstat : To Display information of file using file discripter\n");
...
int CreateFile(char *name,int permission)
{
    ...
    UFDTArr[i].ptrfiletable->readoffset = 1;
    UFDTArr[i].ptrfiletable->writeoffset = 1;
...
int main()
{
    ...
    while(1)
    {
        ...
        if(count == 1)
        {
            ...
            {
                printf("Terminating the marvellous virual file System\n");
                break;
            }
            else
            {
        ...
        else if(count == 3)
        {
            if(strcmp(command[0],"create")==0)
            {
                ...
                if(ret == -3)
                    printf("ERROR : file aready exist\n"); 
                if(ret == -4)
            ...
            else if(count == 4)
            {
                if(strcmp(command[0],"lseek") == 0)
                {
                    ...
                    if(fd == -1)
                    {
                        printf("ERROR : Incorrect paraeter\n");
                        continue;
                    }
